...
/**
 * 跟BaseDaoImpl的区别只是改动了insertAndGetPk(final String sql, final Object[] args)方法,让新增并且获取自增长主键的方法兼容所有的mysql jdbc驱动
 * @author Administrator
 *
 */
@Repository
public class BaseDaoImplV2 implements IBaseDao {
	...
	ExceptionHandler exceptionHandler = new ExceptionHandler(LogFactory.getLog(BaseDaoImplV2.class));
