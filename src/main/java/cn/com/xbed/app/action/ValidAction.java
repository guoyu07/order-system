...
public class ValidAction {
	ExceptionHandler exceptionHandler = new ExceptionHandler(LogFactory.getLog(ValidAction.class));
	@Resource
	...
	/**
	 * OMS系统发送短信   {mobile:"13042014179",content:"test"}
	 * @param req
	 * @param resp
	 * @return
	 */
	...
	public Map<String, Object> sendSms(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			...
			omsMgntService.sendSmsAndLog(mobile, content);
